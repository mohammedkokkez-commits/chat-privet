...
app.get('/chat', requireAuth, (req, res) => {
  ...
  const body =
    ...
    '</form>' +
'<a href="/chat" class="link-btn" style="display: inline-block; color: #333333; font-weight: bold; margin-top: 10px; text-align: center; text-decoration: none;">تحديث المحادثة 🔄</a>' +
'</form>';
